...
public class AreaCientificaExecutable implements Executable {
    ...
    public void execute() throws Throwable {
        ...
        if (this.areaCientificaBD != null) {
            ...
            assertEquals(this.areaCientificaBD.getId(), this.areaCientifica.getId(), "Ids das areas cientificas nao sao iguais");
            assertEquals(this.areaCientificaBD.getNome(), this.areaCientifica.getNome(), "Nomes das areas cientificas nao sao iguais");
        }
    }
}
