...
public enum MassaProfessor {
    ...
    PROFESSOR_01("Professor 01", "professor01@professores.com.br", "f11111111", 2600.00, UEL),

    PROFESSOR_02("Professor 02", "professor02@professores.com.br", "f22222222", 3000.00, UEM),

    PROFESSOR_03("Professor 03", "professor03@professores.com.br", "f33333333", 3500.00, UEPG),

    PROFESSOR_04("Professor 04", "professor04@professores.com.br", "f44444444", 4000.00, UFPR),

    PROFESSOR_05("Professor 05", "professor05@professores.com.br", "f55555555", 4500.00, UTFPR_PATO_BRANCO),

    PROFESSOR_06("Professor 06", "professor06@professores.com.br", "f66666666", 4550.00, UTFPR_TOLEDO);
    ...
    private MassaProfessor(String nome, String email, String telefone, Double salario, MassaInstituicao instituicao) {
        this.email = email;
        this.nome = nome;
